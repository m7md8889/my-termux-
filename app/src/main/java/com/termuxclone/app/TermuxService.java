...
import com.termuxclone.app.event.SystemEventReceiver;
import com.termuxclone.app.terminal.TermuxTerminalSessionActivityClient;
import com.termuxclone.app.terminal.TermuxTerminalSessionServiceClient;
import com.termuxclone.shared.termux.plugins.TermuxPluginUtils;
import com.termuxclone.shared.data.IntentUtils;
import com.termuxclone.shared.net.uri.UriUtils;
import com.termuxclone.shared.errors.Errno;
import com.termuxclone.shared.shell.ShellUtils;
import com.termuxclone.shared.shell.command.runner.app.AppShell;
import com.termuxclone.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.termuxclone.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.termuxclone.shared.termux.shell.TermuxShellUtils;
...
import com.termuxclone.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.termuxclone.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.termuxclone.shared.termux.shell.TermuxShellManager;
...
import com.termuxclone.shared.notification.NotificationUtils;
import com.termuxclone.shared.android.PermissionUtils;
import com.termuxclone.shared.data.DataUtils;
import com.termuxclone.shared.shell.command.ExecutionCommand;
import com.termuxclone.shared.shell.command.ExecutionCommand.Runner;
import com.termuxclone.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.termuxclone.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.termuxclone.shared.R.string.error_execution_cancelled))) {
