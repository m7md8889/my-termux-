...
import com.termuxclone.shared.termux.terminal.io.BellHandler;
import com.termuxclone.shared.logger.Logger;
import com.termuxclone.terminal.TerminalColors;
import com.termuxclone.terminal.TerminalSession;
import com.termuxclone.terminal.TerminalSessionClient;
import com.termuxclone.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.termuxclone/com.termuxclone.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
